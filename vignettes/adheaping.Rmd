...
and the comb is treated as a group-matched atom in the spectral basis by a fourth-order
detector, which abstains rather than guessing and so fires only in a minority of cases.
